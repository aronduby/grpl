...
exports.getTies = function(season_id){
	var d = Q.defer();

	exports.getRankings(season_id)
...
exports.getPointsForNight = function(season_id, starts){
	...
	Q.all([exports.getRankings(season_id, starts), module.parent.exports.machine.getForLeagueNight(starts)])
