...
exports.getAll = function(season_id){
	...
	getPool().getConnection(function(err, db){
		...
		if(season_id != undefined){
			var sql = "SELECT p.*, MAX(pts.season_id) = "+parseInt(season_id,10)+" AS active FROM player p LEFT JOIN player_to_season pts USING(name_key) GROUP BY (name_key) ORDER BY p.last_name";
		} else {
