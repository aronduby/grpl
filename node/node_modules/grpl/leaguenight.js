...
LeagueNight.prototype.getScores = function(){
	...
	getPool().getConnection(function(err, db){
		...
		var sql = "SELECT " + 
				"lns.score_id, lno.night_id, lno.name_key, lns.abbv, lns.points, lns.played_order, lno.grouping, lno.start_order, mtln.mtln_id, mtln.picked_by "+
			"FROM " + 
...
LeagueNight.prototype.saveScores = function(data){
	...
	getPool().getConnection(function(err, db){
		...
		var machine_promise = Q.promise(function(resolve, reject, notify){
			...
			var sql = "INSERT INTO machine_to_league_night (mtln_id, night_id, grouping, abbv, picked_by) VALUES ? ON DUPLICATE KEY UPDATE abbv=VALUES(abbv), picked_by=VALUES(picked_by)";
